...
export default {
  ...
  settings: {
    ...
    system: {
      ...
      autoBackupLast: 'Last backup: {time} · weekly, keeps the latest 10',
      ...
      autoBackupHint: 'Backs up weekly to the folder you pick, keeping only the latest 10 (older ones are cleaned up automatically; renamed backups are never touched). Another drive or a USB disk is safest.',
      oldData: 'Old data',
